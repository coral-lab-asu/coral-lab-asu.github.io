...
<!-- Publication item -->
    <article class="pub-item">
      <figure class="thumb">
        <img src="{{ site.baseurl }}/poster_docs/Enhancing_temporal_poster_placeholder.png" alt="SCoPE thumbnail">
      </figure>

      <div class="pub-body">
        <h3 class="pub-title">
          <a href="https://arxiv.org/pdf/2604.25120" target="_blank" rel="noopener">SCoPE: Planning for Hybrid Querying over Clinical Trial Data</a>
        </h3>
        ...
        <p class="pub-abstract">
          SCoPE studies clinical trial table reasoning, where answers must be inferred from row evidence through semantic normalization, classification, extraction, and lightweight domain reasoning. The planner-executor framework decomposes row selection, structured planning, and grounded execution, improving row-level reasoning over direct prompting and tabular baselines on 1,500 oncology clinical-trial questions.
        </p>

        <div class="pub-links">
          <a class="btn btn-site" href="{{ site.baseurl }}/SCoPE/">website</a>
          <a class="btn btn-code" href="https://github.com/CoRAL-ASU/SCoPE" target="_blank" rel="noopener">code</a>
        </div>
      </div>
    </article>
